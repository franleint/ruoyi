<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="存储区域" prop="storeArea">
        <el-input
          v-model="queryParams.storeArea"
          placeholder="请输入存储区域"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="存储区域" align="center" prop="areaName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="存储区域" prop="storeArea">
          <el-select v-model="form.storeArea" @focus="getArea" placeholder="请选择存储区域" >
            <el-option
              v-for="area in storeArea"
              :key="area.areaId"
              :label="area.areaName"
              :value="area.areaId"
            />
        ...
        <el-form-item label="分类编号" prop="categoryCode">
          <el-input v-model="form.categoryCode" placeholder="请输入分类编号" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
        ...
        <el-form-item label="借阅人" prop="borrowerName">
          <el-input v-model="form.borrowerId" placeholder="请输入借阅人" />
        </el-form-item>
...
<script>
import { listBook, getBook, delBook, addBook, updateBook,getAreaList,borrow } from "@/api/system/book"
...
export default {
  ...
  methods: {
    ...
    handleBorrow(row) {
      ...
      borrow(row.bookId).then(response => {
    ...
    async getArea(){
      console.log(this.storeArea)
      try{
        if(this.storeArea.length === 0){
          const res = await getAreaList();
          this.storeArea = res.rows;
        }
        console.log(this.storeArea);
        }catch(err) {
